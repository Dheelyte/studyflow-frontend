      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '32px', lineHeight: '1.6' }}>
        <section>
          ...
          <p style={{ color: 'var(--secondary)' }}>
            By accessing or using Studywise, you agree to be bound by these Terms of Service and our Privacy Policy. If you do not agree to these terms, you may not access or use the service.
          </p>
        </section>
        ...
        <section>
          ...
          <p style={{ color: 'var(--secondary)' }}>
            Studywise provides an AI-powered curriculum generation tool. You are granted a limited, non-exclusive, non-transferable license to use the service for personal, non-commercial purposes.
          </p>
        </section>
        ...
        <section>
            ...
            <p style={{ color: 'var(--secondary)' }}>
                Studywise shall not be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the service.
            </p>
        </section>
        ...
        <section>
            ...
            <p style={{ color: 'var(--secondary)' }}>
                If you have any questions about these Terms, please contact us at: support@studywise.example.com
            </p>
        </section>
      </div>
    </div>
