...
export const CommunityQuestion = () => {
  ...
  const cam = useCameraPath(
    ...
    [
      ...
      { frame: T.typeStart - 4, x: headerFocusX, y: nameMembersFocusY, scale: 2.2 },
      { frame: T.typeStart + 23, x: postCenterX, y: questionY, scale: 2.1 },
      { frame: T.typeEnd, x: postCenterX, y: questionY + 10, scale: 2.1 },
      { frame: T.comment1[0] + 10, x: postCenterX, y: commentsY, scale: 1.95 },
